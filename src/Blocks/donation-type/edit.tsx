...
import { DONATION_TYPES, DonationType } from '../common/DonationType.ts'
...
export default function Edit({
	...
	const { 'famehelsinki/donation-form/types': enabledTypes } = context
	...
	console.log('editt', enabledTypes, types, value)
